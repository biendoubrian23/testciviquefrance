/**
 * Contenu SEO : Retraite des étrangers en France 2026
 * Droits, ASPA, cotisations, conventions bilatérales et retour au pays
 */

import type { ArticleFullContent } from './articles-part1';

export const retraiteEtrangersFranceContent: ArticleFullContent = {
  ...
  sections: [
    {
      id: 'droits-retraite-etrangers-principe',
      title: 'Les étrangers ont-ils droit à une retraite en France ?',
      content: `**Oui, les ressortissants étrangers qui ont travaillé et cotisé en France ont les mêmes droits à la retraite que les Français.** Le droit à la retraite ne dépend pas de la nationalité, mais des **cotisations versées** au régime français.
...
1. **Avoir cotisé au moins 1 trimestre** au régime français (régime général, MSA, RSI/SSI, etc.)
2. **Avoir atteint l'âge légal de départ** : **64 ans** en 2026 (suite à la réforme des retraites 2023)
3. **En faire la demande** : la retraite n'est pas versée automatiquement, vous devez la demander 6 mois avant la date souhaitée
...
Ce montant peut être complété par les trimestres cotisés à l'étranger (via convention bilatérale) ou par l'ASPA si vous résidez en France.`,
    ...
    {
      id: 'conventions-bilaterales-totalisation',
      title: 'Conventions bilatérales : cumuler vos trimestres étrangers et français',
      content: `La France a signé des **conventions bilatérales de sécurité sociale** avec plus de 40 pays. Ces accords permettent de **totaliser** les périodes travaillées dans chaque pays pour le calcul de vos droits.
...
| **Afrique** | Sénégal, Mali, Cameroun, Côte d'Ivoire, Congo, Gabon, Bénin, Togo, Niger, Burkina Faso, Mauritanie, Cap-Vert |
| **Europe (hors UE)** | Turquie, Bosnie, Serbie, Monténégro, Kosovo, Macédoine du Nord, Andorre, Monaco |
| **Amériques** | USA, Canada, Québec, Brésil, Chili, Argentine, Uruguay |
| **Asie / Océanie** | Japon, Corée du Sud, Inde, Israël, Philippines, Australie |
| **UE/EEE/Suisse** | Tous les pays (règlements européens 883/2004) |

### Comment faire valoir vos trimestres étrangers ?

1. **Lors de votre demande de retraite**, indiquez vos périodes d'activité à l'étranger
2. La **CNAV (ou votre caisse)** contacte l'organisme de retraite du pays partenaire
3. Chaque pays calcule sa **part proportionnelle** et vous verse sa pension séparément
4. Le délai de traitement est plus long (6-12 mois) en raison des échanges entre caisses
...
Si vous avez travaillé dans un pays **sans convention** (ex : Chine, Russie, Égypte, Nigéria...), ces trimestres **ne comptent pas** pour la retraite française. Vous devrez faire une demande séparée auprès du régime de ce pays.`,
    },
    {
      ...
      title: "L'ASPA (minimum vieillesse) : conditions spécifiques pour les étrangers",
      content: `L'**Allocation de Solidarité aux Personnes Âgées (ASPA)** est une prestation qui garantit un revenu minimum aux personnes de 65 ans et plus ayant de faibles ressources. En 2026, elle est d'environ **1 012 € par mois** pour une personne seule et **1 571 €** pour un couple.

### Conditions pour les étrangers

Pour percevoir l'ASPA, un étranger doit :

1. **Avoir 65 ans ou plus** (ou 62 ans si reconnu inapte au travail)
2. **Résider en France de manière stable et régulière** (au moins **9 mois par an** sur le territoire français)
3. **Disposer d'un titre de séjour** autorisant à travailler : carte de résident, carte de séjour pluriannuelle, ou titre de séjour depuis au moins 10 ans
4. **Avoir des ressources inférieures au plafond** : 1 012 €/mois (personne seule) ou 1 571 €/mois (couple) en 2026

### Titres de séjour acceptés pour l'ASPA

| Titre de séjour | Éligible ASPA ? |
|-----------------|----------------|
...
| Pays de retour | Pension privée française | Pension publique française |
|---------------|-------------------------|---------------------------|
| **Maroc** | Imposable au Maroc uniquement | Imposable en France |
| **Algérie** | Imposable en Algérie uniquement | Imposable en France |
| **Tunisie** | Imposable en Tunisie uniquement | Imposable en France |
| **Turquie** | Imposable en Turquie uniquement | Imposable en France |
| **Sénégal** | Imposable au Sénégal uniquement | Imposable en France |
| **Pas de convention** | Imposable en France (retenue à la source) | Imposable en France |
...
**Attention** : si vous ne renvoyez pas le certificat de vie dans les délais, votre pension est **suspendue**.`,
    ...
    {
      id: 'cas-particuliers',
      title: 'Cas particuliers : conjoints rejoignants, réfugiés, travailleurs détachés',
      content: `### Conjoints rejoignants (regroupement familial)
...
Si vous avez travaillé en France **sans titre de séjour** mais que des cotisations ont effectivement été versées (par l'employeur), ces trimestres **comptent** pour la retraite. Vous devrez régulariser votre situation pour faire valoir ces droits.`,
    ...
    {
      id: 'demarches-demande-retraite',
      title: 'Démarches pratiques : comment demander votre retraite en 2026',
      content: `### Quand faire la demande ?
...
**En ligne** (recommandé) :
1. Connectez-vous sur **[lassuranceretraite.fr](https://www.lassuranceretraite.fr)** (régime général)
2. Ou sur **[info-retraite.fr](https://www.info-retraite.fr)** (portail inter-régimes)
3. Remplissez le formulaire de demande unique (qui couvre tous vos régimes)
...
- Relevé de carrière (disponible sur [lassuranceretraite.fr](https://www.lassuranceretraite.fr))
- RIB bancaire
- Avis d'imposition
- Livret de famille
...
Utilisez le simulateur officiel **[m@rel](https://www.info-retraite.fr/simulateur)** sur info-retraite.fr pour estimer le montant de votre future pension. Le simulateur prend en compte tous vos régimes et vous donne une estimation fiable.`,
    },
    {
      id: 'lien-naturalisation-retraite',
      title: 'Retraite et naturalisation : quel lien ?',
      content: `### La retraite n'empêche pas la naturalisation
...
- Les **droits et devoirs** du citoyen`,
  ...
  conclusion: `Les étrangers ayant travaillé en France ont pleinement droit à une retraite française, calculée sur les mêmes bases que pour les nationaux. Grâce aux conventions bilatérales signées avec plus de 40 pays, vous pouvez cumuler vos trimestres cotisés en France et à l'étranger. L'ASPA offre un filet de sécurité aux plus de 65 ans sous conditions de résidence — mais attention au piège des 9 mois de présence obligatoire en France. Si vous envisagez un retour au pays, votre pension de base vous suit, mais l'ASPA et certaines aides sont perdues. Planifiez votre retraite en vérifiant votre relevé de carrière dès maintenant sur info-retraite.fr, et si vous souhaitez devenir Français à la retraite, c'est tout à fait possible via la naturalisation.`,
  faq: [
    {
      question: 'Un étranger a-t-il droit à la retraite en France ?',
      answer: "Oui, tout étranger ayant travaillé et cotisé au régime français a droit à une pension de retraite, quelle que soit sa nationalité. Le droit est basé sur les cotisations versées, pas sur la nationalité.",
    },
    {
      question: "Qu'est-ce que l'ASPA et un étranger peut-il en bénéficier ?",
      answer: "L'ASPA (Allocation de Solidarité aux Personnes Âgées) est le minimum vieillesse (~1 012 €/mois en 2026). Un étranger peut en bénéficier à 65 ans s'il réside en France au moins 9 mois/an et détient un titre de séjour autorisant le travail depuis suffisamment longtemps.",
    },
    {
      question: 'Puis-je toucher ma retraite française si je retourne au Maroc ?',
      answer: "Oui, votre pension de retraite de base et complémentaire est versée au Maroc. En revanche, l'ASPA (minimum vieillesse) est supprimée car elle exige de résider en France au moins 9 mois par an. Grâce à la convention fiscale, votre pension privée sera imposée au Maroc uniquement.",
    },
    {
      question: 'Comment cumuler mes trimestres de retraite travaillés dans deux pays ?',
      answer: "Si la France a une convention bilatérale avec votre pays d'origine (Maroc, Algérie, Tunisie, Sénégal, etc.), vos trimestres sont totalisés pour le calcul de vos droits. Chaque pays verse ensuite sa part proportionnelle. Indiquez vos périodes d'activité à l'étranger lors de votre demande de retraite.",
    },
    {
      question: "Qu'est-ce que le certificat de vie pour les retraités à l'étranger ?",
      answer: "C'est un document annuel attestant que vous êtes en vie, à envoyer à votre caisse de retraite pour continuer à percevoir votre pension depuis l'étranger. Il est délivré par le consulat français ou les autorités locales. Sans ce certificat, votre pension est suspendue.",
    },
    {
      question: 'Puis-je demander la naturalisation française à la retraite ?',
      answer: "Oui, être retraité n'empêche pas la naturalisation. Vous devez résider en France, justifier d'un niveau B1 en français, passer le test civique et démontrer votre intégration. Votre pension de retraite peut constituer la preuve de ressources suffisantes.",
    },
  ],
  keywords: [
    'retraite étranger France',
    'ASPA étranger conditions 2026',
    'pension retraite titre séjour',
    'retraite Maroc France convention',
    'minimum vieillesse étranger',
    'retour pays origine retraite',
    'certificat de vie retraite étranger',
    'trimestres retraite cotisés étranger',
    'convention bilatérale sécurité sociale France',
    'calcul retraite étranger France',
    'pension réversion étranger',
    'naturalisation retraité France',
  ],
  sources: [
    {
      ...
      type: 'official',
      description: 'Portail officiel de la retraite du régime général',
    },
    {
      title: 'Info-retraite.fr — Portail inter-régimes',
      url: 'https://www.info-retraite.fr',
      type: 'official',
      description: 'Simulateur et relevé de carrière tous régimes',
    },
    {
      title: 'Service-public.fr — ASPA',
      url: 'https://www.service-public.fr/particuliers/vosdroits/F16871',
      type: 'official',
      description: "Conditions d'attribution de l'ASPA",
    },
    {
      title: 'CLEISS — Centre de liaisons européennes et internationales de sécurité sociale',
      url: 'https://www.cleiss.fr/docs/textes/index.html',
      type: 'official',
      description: 'Liste des conventions bilatérales de sécurité sociale',
    },
  ],
};
