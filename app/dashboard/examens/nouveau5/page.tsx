...
// ==================== EXAMEN BLANC #5 ====================
const EXAM_NUMBER = 5;
const QUESTIONS_EXAMEN = EXAMEN_5.questions;
...
export default function NouvelExamen5Page() {
  ...
  const calculateScore = useCallback(() => {
    return userAnswers.reduce((acc, answer, idx) => {
      ...
      if (answer.selectedIndex !== null && verifyAnswerExam5(question.id, answer.selectedIndex, question.correctHash)) {
        return acc + 1;
      }
      return acc;
    }, 0);
  ...
  if (phase === 'revision') {
    ...
    const correctIndex = findCorrectIndexExam5(currentQuestion.id, currentQuestion.correctHash);
          ...
          <div className="mt-6 pt-4 border-t border-gray-100">
            <div className="flex flex-wrap justify-center gap-1 mb-4">
              {QUESTIONS_EXAMEN.map((q, idx) => {
                ...
                const qCorrectIndex = findCorrectIndexExam5(q.id, q.correctHash);
