...
// Fonction de hash (identique à nouveau/page.tsx)
...
// Trouver l'index correct à partir du hash
...
// Interface Question (même structure que nouveau/page.tsx)
interface Question {
  id: number;
  categorie: string;
...
// Les 40 questions de l'examen (identique à nouveau/page.tsx)
const QUESTIONS_EXAMEN: Question[] = [
  // PRINCIPES ET VALEURS (11 questions)
  {
    id: 1,
    ...
    <div className="max-w-4xl mx-auto px-4 py-6 space-y-6">
      ...
      <div className="bg-white border border-gray-200 p-6">
        <div className="flex items-start justify-between mb-4">
          <div>
            ...
            <p className="text-sm text-gray-500">{formatDate(examen.completed_at)}</p>
          </div>
          <button
      ...
      <div className="bg-white border border-gray-200 p-4">
        <div className="flex items-center justify-between mb-3">
          <h3 className="font-semibold text-gray-900">Question {currentQuestionIndex + 1} / {QUESTIONS_EXAMEN.length}</h3>
          <div className="text-sm text-gray-500">
            {examen.current_answers.filter((a) => {
              const q = QUESTIONS_EXAMEN.find(question => question.id === a.questionId);
              if (!q) return false;
              const correct = findCorrectIndex(q.id, q.correctHash);
      ...
      <div className="bg-white border border-gray-200 p-4">
        <div className="flex items-center justify-between">
          ...
          <span className="text-sm text-gray-500">
            Question {currentQuestionIndex + 1} / {QUESTIONS_EXAMEN.length}
          </span>

          <button
            onClick={handleNext}
            disabled={currentQuestionIndex === QUESTIONS_EXAMEN.length - 1}
            className={`flex items-center gap-2 px-4 py-2 border border-gray-200 ${
