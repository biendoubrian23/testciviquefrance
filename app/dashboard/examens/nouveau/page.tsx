            ...
            <>
              ...
              <div className="flex flex-col gap-3">
                <button
                  ...
                  className="glass-cta w-full py-3 px-4 font-semibold rounded-xl active:scale-95"
                  style={{ WebkitTapHighlightColor: 'transparent' }}
                >
                  Revoir les réponses
                </button>
                <button
                  ...
                  className="glass-pill w-full py-3 px-4 font-medium flex items-center justify-center gap-2"
                  style={{ WebkitTapHighlightColor: 'transparent' }}
                >
  ...
  if (phase === 'revision') {
    ...
    return (
      <div className="max-w-4xl mx-auto px-0 sm:px-4 py-1 sm:py-6">
        <div className="glass-card p-2 sm:p-4 mb-2 sm:mb-6 flex items-center justify-between">
          <div>
        ...
        <div className="glass-card p-2 sm:p-6">
          <div className={`inline-flex items-center gap-2 px-3 py-1 mb-2 text-sm font-medium rounded-full ${
            isCorrect
          ...
          <div className="space-y-3 mb-6">
            {currentQuestion.options.map((option, optIdx) => {
              ...
              let optionClass = 'border-white/50 bg-white/30';
              if (isCorrectOption) {
                optionClass = 'border-emerald-500 bg-emerald-50/80';
