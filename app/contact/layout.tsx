...
export const metadata: Metadata = {
  title: 'Contact - Test Civique France 2026 | Assistance Naturalisation & Immigration',
  description: 'Contactez Test Civique France pour toute question sur la préparation au test civique 2026. Support 7j/7. Aide naturalisation, titre de séjour, étudiants étrangers, nouvelle loi immigration.',
  keywords: [
  ...
  openGraph: {
    title: 'Contact - Test Civique France 2026',
