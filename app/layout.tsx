      ...
      <body className="antialiased" suppressHydrationWarning>
        ...
        <Script id="inspectlet" strategy="afterInteractive">
          {`
            ...
            __insp.push(['wid', 998405009]);
            var ldinsp = function(){
            if(typeof window.__inspld != "undefined") return; window.__inspld = 1; var insp = document.createElement('script'); insp.type = 'text/javascript'; insp.async = true; insp.id = "inspsync"; insp.src = ('https:' == document.location.protocol ? 'https' : 'http') + '://cdn.inspectlet.com/inspectlet.js?wid=998405009&r=' + Math.floor(new Date().getTime()/3600000); var x = document.getElementsByTagName('script')[0]; x.parentNode.insertBefore(insp, x); };
            setTimeout(ldinsp, 0);
            })();
          `}
        </Script>
        ...
        <Script id="smartlook" strategy="afterInteractive">
          {`
            ...
            smartlook('init', '4badc6089313a952efcf93e767c97204ff32d090', { region: 'eu' });
          `}
        </Script>
